...
navigation/
    ...
    - DriverSettingsStack.tsxStack navigator nested inside the driver Settings tab. Handles pushing sub-screens like Edit Profile, Vehicle Details, Shift Times.
...
pages/settings/
    ...
    - NotificationPrefs.tsx - Both roles. Toggle individual notification types — attendance reminder, trip started, driver approaching (passenger), new passenger joined (driver).
